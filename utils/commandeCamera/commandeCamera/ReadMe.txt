========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet commandeCamera
========================================================================

AppWizard a cr&eacute;&eacute; cette application commandeCamera pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application commandeCamera.


commandeCamera.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; commandeCamera.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
